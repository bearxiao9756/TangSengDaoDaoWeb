...
export default class WKAvatar extends Component<WKAvatarProps, WKAvatarState> {
    ...
    getImageSrc() {
        ...
        if (imgSrc.includes("https://43.133.38.23:9000/")){
            imgSrc = imgSrc.replace("https://43.133.38.23:9000","https://shanghaihuanian123.icu/img")
          
            console.log(imgSrc);
        }
        if(!imgSrc.includes("https://shanghaihuanian123.icu")){
            imgSrc = "https://shanghaihuanian123.icu"+imgSrc;
        }
        return imgSrc
    }
    handleImgError() {
