    ...
    async getUploadURL(path:string) :Promise<string|undefined> {
       ...
       if(result) {
            ...
            if(uploadurl.includes('http://43.133.38.23:8090')){
                uploadurl = uploadurl.replace('http://43.133.38.23:8090', 'https://ac1024.com/api')
            }
            if(uploadurl.includes('http://ac1024.com:8090/')){
                uploadurl = uploadurl.replace('http://ac1024.com:8090', 'https://ac1024.com/api')
            }
            if(uploadurl.includes('https://ac1024.com:8090/')){
                uploadurl = uploadurl.replace('https://ac1024.com:8090', 'https://ac1024.com/api')
            }
