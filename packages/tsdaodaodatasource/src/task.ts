    ...
    async getUploadURL(path:string) :Promise<string|undefined> {
       ...
       if(result) {
            ...
            if(uploadurl.includes('http://43.133.38.23:8090')){
                uploadurl = uploadurl.replace('http://43.133.38.23:8090', 'https://chuqingqing.icu/api')
            }
            if(uploadurl.includes('http://chuqingqing.icu:8090/')){
                uploadurl = uploadurl.replace('http://chuqingqing.icu:8090', 'https://chuqingqing.icu/api')
            }
            if(uploadurl.includes('https://chuqingqing.icu:8090/')){
                uploadurl = uploadurl.replace('https://chuqingqing.icu:8090', 'https://chuqingqing.icu/api')
            }
